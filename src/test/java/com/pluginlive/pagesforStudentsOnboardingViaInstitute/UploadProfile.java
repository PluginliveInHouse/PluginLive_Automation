...
public class UploadProfile extends BaseClass {
    ...
    //String profilepic = readExcelData1("StudentsOnboardingViaInstitute", 1, 18);
    ...
    public void uploadphoto(String profilepic) throws InterruptedException, AWTException {
